...
<body>
			...
			<div class="col-sm-8">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="prefix" class="input-text radius" value="" placeholder="手机号码前缀" name="prefix">
					</div>
				</div>
	...
	<script type="text/javascript" src="${ctx}/js/phoneOperator/phoneOperator.add.js"></script>
</body>
</html>